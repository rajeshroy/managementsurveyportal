sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("man/survey/portal/app", ".html");
		...
		return Opa5.extend("man.survey.portal.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["man/survey/portal/localService/mockserver"], function (mockserver) {
