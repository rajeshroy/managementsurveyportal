sap.ui.define([
	...
	"sap/ui/Device",
	"mana/survey/portal/model/models",
	"mana/survey/portal/controller/ErrorHandler"
], function(UIComponent, Device, models, ErrorHandler) {
	"use strict";

	return UIComponent.extend("mana.survey.portal.Component", {

		metadata: {
			"version": "1.0.0",
			"rootView": {
				"viewName": "mana.survey.portal.view.App",
				"type": "XML",
				"id": "app"
			},
			"dependencies": {
			...
			"config": {
				"i18nBundle": "mana.survey.portal.i18n.i18n",
				"serviceUrl": "/sap/opu/odata/sap/ZCUST_FEEDBACK_SRV/",
				"icon": "",
				"favIcon": "",
				"phone": "",
				"phone@2": "",
			...
			"routing": {
				"config": {
					...
					"viewType": "XML",
					"viewPath": "mana.survey.portal.view",
					"controlId": "app",
				...
				"routes": [{
					...
					"pattern": "CustomerDetSet/{objectId}",
					"name": "object",
					"target": [
						"object"
					]
				}, {
					"pattern": "CustomerDetSe89t/{objectId},{custId}",
					"name": "manager",
					"target": [
						"manager"
					]
